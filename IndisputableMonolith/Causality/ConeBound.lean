...
/-! ConeBound: BFS n-ball and cardinality bounds (dependency-light). -/
...
/-! Minimal ConeBound: relies on `BoundedStep`, `Kinematics`, and `ballP` being available
    from extracted Causality modules. -/
