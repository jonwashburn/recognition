...
-- (Moved to IndisputableMonolith/Verification/KnobsCount.lean)
...
-- (Moved to IndisputableMonolith/MaxwellDEC.lean)
...
-- (Moved to IndisputableMonolith/Potential.lean)
...
-- (Moved to IndisputableMonolith/ClassicalBridge/CoarseGrain.lean)
...
-- (Moved to IndisputableMonolith/ClassicalBridge/T4Correspondence.lean)
...
-- (Moved to IndisputableMonolith/Constants/RSDisplay.lean)
...
-- (Moved to IndisputableMonolith/Masses/Exponent/Gauge.lean)

-- (Moved to IndisputableMonolith/Masses/ExponentKernel.lean)
...
namespace IndisputableMonolith
namespace YM
-- (Moved to IndisputableMonolith/YM/Kernel.lean)
end YM
...
-- (Moved to IndisputableMonolith/PhiSupport/Lemmas.lean)
end IndisputableMonolith

-- (Moved to IndisputableMonolith/Ethics/CostModel.lean)
...
-- (Moved to IndisputableMonolith/URCAdapters/PhiRung.lean)
end IndisputableMonolith
...
-- (Moved to IndisputableMonolith/TruthCore/MRD/Scaling.lean)
...
-- (Moved to IndisputableMonolith/TruthCore/TimeKernel.lean)
